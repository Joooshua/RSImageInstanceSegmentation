...
import numpy as np
from libs.nn import SynchronizedBatchNorm2d
...
model_path = './pretrained_weights/hrnetv2_w48-imagenet.pth'
...
class HRNetV2(nn.Module):
    def __init__(self, n_class, **kwargs):
        ...
        extra = {
            ...
            'STAGE4': {'NUM_MODULES': 3, 'NUM_BRANCHES': 4, 'BLOCK': 'BASIC', 'NUM_BLOCKS': (4, 4, 4, 4), 'NUM_CHANNELS': (48, 96, 192, 192), 'FUSE_METHOD': 'SUM'},
            'FINAL_CONV_KERNEL': 1
            }
